  ...
  groups: [
    {
      ...
      keys: [
        ...
        {
          key: "pix_tipo",
          description: "Tipo da chave PIX (ex.: CPF, E-mail, Telefone)",
        },
        { key: "pix_chave", description: "Chave PIX do método de pagamento" },
...
export const ROUTE_MAP_TEMPLATE_KEYS: TemplateKeysDoc = {
  ...
  groups: [
    ...
    },
    {
      ...
      description:
        "Repetidos para cada paciente da unidade. Consultas do mesmo paciente com o mesmo acompanhante são agrupadas; se o acompanhante variar entre consultas, o paciente aparece uma vez para cada acompanhante.",
      loop: "pacientes",
      keys: [
